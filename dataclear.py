...
print('현재 기기의 One UI 버전이 필요합니다. 안내에 따라 One UI 버전을 확인하여 입력해주세요.')
...
baseSolution = 'https://namu.wiki/w/Game%20Optimizing%20Service#s-6.'
if ver == '1':
    ...
    for i in [b'List', b'of', b'devices', b'attached']:
        devices.remove(i)
    ...
    print('이 링크를 참고하여 진행해주세요.')
    print(baseSolution + '3')
else:
    print('프로그램을 종료합니다.')